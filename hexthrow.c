...
// Description : This program is my implementation to hexdump utility. It takes path_to_file as a 
//				 command line argument and returns a hexdump of it. Produces space character in all
//				 the places where '\n' or '\t' occurs to maintain allignment.
